...
const VANS = [
  ...
  },
  {
    ...
    criteria: {
      ...
      height_mm: 2700, width_mm: 1920, length_mm: 6165, turning_circle_m: 11.5,
  ...
  },
  {
    ...
    criteria: {
      ...
      cargo_length_mm: 4070, cargo_width_mm: 1870, cargo_height_mm: 2172,
      height_mm: 2850, width_mm: 2050, length_mm: 6363, turning_circle_m: 15.3,
      price_eur: 68244, motor_kw: 205,
    },
    notes: "Dutch MY14 price list per 1/4/2026 (NL): catalogue price 56,400 excl. / 68,244 incl. BTW (VAT incl. figure used, like the other entries' street prices). N2 (4.25t) homologation gives GVW 4,250 kg but top speed limited to 90 km/h in all drive modes. Kerb 2,940 kg, payload 1,310 kg, WLTP range 406 km combined (491 city, 273 Wh/km). Battery 110.6 installed / 97.8 usable kWh; 150 kW DC, 22 kW AC OBC (standard); no AC power outlet (e-PTO option 4204 is 400 V DC 7 kW); motor 205 kW/410 Nm (Power mode). Turning circle 15.3 m (L4 = long wheelbase + extra overhang). Cargo 4,070 x 1,870 x 2,172 mm / 17 m³, overall 6,363 x 2,050 x 2,850 mm, wheelbase 4,035 mm. Battery warranty 8y/160,000 km (to 70% capacity).",
  ...
  },
  {
    ...
    criteria: {
      ...
      height_mm: 2850, width_mm: 2050, length_mm: 5998, turning_circle_m: 14.3,
      price_eur: 67155, motor_kw: 205,
    },
    notes: "Dutch MY14 price list per 1/4/2026 (NL): catalogue price 55,500 excl. / 67,155 incl. BTW. N1 (3.5t) homologation: GVW 3,500 kg, 130 km/h (Normal/Power modes). Kerb 2,890 kg, payload 610 kg, WLTP range 359 km (dimensions table says 358; 310 Wh/km). Same 97.8 usable kWh battery, 150 kW DC, 22 kW AC (standard); no AC power outlet (e-PTO option 4204 is 400 V DC 7 kW); 205 kW/410 Nm (Power mode). Turning circle 14.3 m (L3 = long wheelbase without extra overhang). Cargo 3,705 x 1,870 x 2,172 mm / 15 m³, overall 5,998 x 2,050 x 2,850 mm, wheelbase 4,035 mm.",
    sources: ["prijslijst-citroen-e-jumper-my14-per-1-april-2026.pdf", "research/prijslijst-citroen-e-jumper-my14-per-1-april-2026.md"],
  },
];
