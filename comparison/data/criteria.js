...
const CRITERIA = [
  ...
  { id: "cargo_height_mm",     label: "Cargo height",   unit: "mm",  direction: "high", weight: 9, min: 2000, hint: "Standing height in the cargo area - hard minimum 2000 mm" },
  ...
  { id: "turning_curb_m",      label: "Turn circle (curb)", unit: "m", direction: "low",  weight: 8, hint: "Curb-to-curb turning diameter (body/tires only) - smaller = easier to park and manoeuvre" },
  ...
  { id: "kerb_weight_kg",      label: "Kerb weight",    unit: "kg",  direction: "low",  weight: 0, hint: "Vehicle weight as-delivered incl. battery - lighter = more payload headroom" },
  { id: "gvw_kg",              label: "GVW",            unit: "kg",  direction: "high", weight: 0, hint: "Gross vehicle weight - the max allowed weight of the van (3.5t vs 4.25t class); above 3,500 kg needs C1E licence + higher taxes in most EU countries, but gives more fit-out headroom" },
];
